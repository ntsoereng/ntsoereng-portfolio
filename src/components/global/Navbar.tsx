...
export default function Navbar() {
  ...
  return (
    <header className="header shadow-lg h-[calc(var(--header-height)+1rem)] w-full fixed top-0 left-0 py-0 px-6 lg:py-2 z-fixed flex justify-between items-center dark:bg-darkColor/70 bg-white/80 backdrop-blur-md">
